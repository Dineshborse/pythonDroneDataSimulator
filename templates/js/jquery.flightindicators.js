(function ($) {
  ...
  function FlightIndicator(placeholder, type, options) {
    ...
    function _setPitch(pitch) {
      ...
      placeholder.each(function () {
        $(this)
          .find("div.instrument.attitude div.attitude div.attitude_pitch")
    ...
    function _setOffFlag(visible) {
      placeholder.each(function () {
        $(this)
          .find("div.instrument.attitude div.attitude_off_flag")
          .toggle(visible);
      });
    }
    ...
    function _setILS(visible) {
      placeholder.each(function () {
        $(this)
          .find("div.instrument.attitude div.attitude_ils")
          .toggle(visible);
      });
    }
    ...
    function _setILSLocalizer(angle) {
      ...
      placeholder.each(function () {
        $(this)
          .find("div.instrument.attitude div.attitude_ils_localizer")
          .css({
    ...
    function _setILSGlideslope(angle) {
      ...
      placeholder.each(function () {
        $(this)
          .find("div.instrument.attitude div.attitude_ils_glideslope")
          .css({
            transform: "rotate(" + ang + "deg)",
    ...
    function _setAltitude(altitude) {
      ...
      placeholder.each(function () {
        $(this)
          ...
          .css("transform", "rotate(" + hand100 + "deg)");
        $(this)
          .find("div.instrument.altimeter div.altimeter_hand1000")
    ...
    function _setPressure(pressure, milibar) {
      ...
      if (milibar !== true) {
        ...
        if (pressure >= 925 && pressure <= 1120) {
          ...
          pressure2 = (pressure * 0.02953 - 27.1) * 60;
        }
      }

      placeholder.each(function () {
        $(this)
          .find("div.instrument.altimeter div.altimeter_pressurembar")
          .css("transform", "rotate(" + pressure1 + "deg)");
      });
      placeholder.each(function () {
        $(this)
          .find("div.instrument.altimeter div.altimeter_pressureinhg")
          .css("transform", "rotate(" + -pressure2 + "deg)");
      });
    }
      ...
      if (typeof d3 != "undefined") {
        ...
        try {
          placeholder.each(function () {
            var i = this;
            d3.xml(
              settings.img_directory + "turn_ball_path.svg",
              "image/svg+xml",
              function (xml) {
                $(i)
                  .find("div.instrument.turn div.turn_ball_path")
          ...
          console.log(
            "Unable to load turn_ball_path.svg. Injecting a path instead."
          );
          placeholder.each(function () {
            d3.select($(this).find("div.instrument.turn div.turn_ball_path")[0])
              .append("svg")
              .attr("width", 400)
              .attr("height", 400)
              .attr("class", "box")
              ...
              .attr(
                "d",
                "m 126.04736,251.79367 c 32.2868,5.88557 51.30081,7.6955 74.28947,7.69341 22.93061,0.002 41.52108,-1.7986 73.61092,-7.64849"
              );
          });
        }
    ...
    function _setTurn(turn) {
      placeholder.each(function () {
        $(this)
          .find("div.instrument.turn div.turn_airplane")
    ...
    function _setHeading(heading) {
      placeholder.each(function () {
        $(this)
          .find("div.instrument.heading div.heading_yaw")
    ...
    function _setBeaconOne(heading, visible) {
      if (visible)
        placeholder.each(function () {
          $(this)
            .find("div.instrument.heading div.heading_beacon_1")
            .show()
            .css("transform", "rotate(" + heading + "deg)");
        });
      else
    ...
    function _setBeaconTwo(heading, visible) {
      if (visible)
        placeholder.each(function () {
          $(this)
            .find("div.instrument.heading div.heading_beacon_2")
            .show()
            .css("transform", "rotate(" + heading + "deg)");
        });
      else
    ...
    function _setVario(vario) {
      ...
      placeholder.each(function () {
        $(this)
          .find("div.instrument.vario div.vario_hand")
          .css("transform", "rotate(" + deg + "deg)")
    ...
    placeholder.each(function () {
      switch (type) {
        case "airspeed":
          $(this).html(
            '<div class="instrument airspeed"><div class="indicator_background"><img src="' +
              ...
              settings.img_directory +
              'airspeed_markings.svg" class="box" alt="" /></div><div class="airspeed box"><img src="' +
              settings.img_directory +
              'airspeed_hand.svg" class="box" alt="" /></div></div><div class="indicator_foreground"><img src="' +
              settings.img_directory +
        ...
        case "attitude":
          $(this).html(
            '<div class="instrument attitude"><div class="indicator_background"><img src="' +
              ...
              settings.img_directory +
              'attitude_foreground_1.svg" class="box" alt="" /></div><div class="attitude_ils"><img src="' +
              settings.img_directory +
              'attitude_ils_markings.svg" class="box" alt="" /><div class="attitude_ils_localizer box"><img src="' +
              settings.img_directory +
              'attitude_ils_localizer.svg" class="box" alt="" /></div><div class="attitude_ils_glideslope box"><img src="' +
              settings.img_directory +
              'attitude_ils_glideslope.svg" class="box" alt="" /></div></div><div class="attitude_foreground_2"><img src="' +
              settings.img_directory +
        ...
        case "turn_coordinator":
          $(this).html(
            '<div class="instrument turn"><div class="indicator_background"><img src="' +
              settings.img_directory +
              'indicator_background_dashboard.svg" class="box" alt="" /></div><div class="indicator_background_screws"><img src="' +
              settings.img_directory +
              'indicator_background_screws.svg" class="box" alt="" /></div><div class="indicator_inner"><div class="turn_markings_1 box"><img src="' +
              settings.img_directory +
              'turn_markings_1.svg" class="box" alt="" /></div><div class="turn_ball_path box" hidden></div><div class="turn_ball box"><img src="' +
              settings.img_directory +
              'turn_ball.svg" class="box" alt="" /></div><div class="turn_airplane box"><img src="' +
              settings.img_directory +
              'turn_airplane.svg" class="box" alt="" /></div><div class="turn_markings_2 box"><img src="' +
              settings.img_directory +
              'turn_markings_2.svg" class="box" alt="" /></div></div><div class="indicator_foreground"><img src="' +
              settings.img_directory +
              'indicator_foreground.svg" class="box" alt="" /></div></div>'
          );
          _loadBallPath();
        ...
        case "heading":
          -$(this).html(
            '<div class="instrument heading"><div class="indicator_background"><img src="' +
              settings.img_directory +
              'indicator_background_dashboard.svg" class="box" alt="" /></div><div class="indicator_background_screws"><img src="' +
              settings.img_directory +
              'indicator_background_screws.svg" class="box" alt="" /></div><div class="indicator_inner"><div class="heading_background box"><img src="' +
              settings.img_directory +
              'heading_background.svg" class="box" alt="" /></div><div class="heading_yaw box"><img src="' +
              settings.img_directory +
              'heading_yaw.svg" class="box" alt="" /></div><div class="heading_beacon_2 box"><img src="' +
              settings.img_directory +
              'heading_beacon_2.svg" class="box" alt="" /></div><div class="heading_beacon_1 box"><img src="' +
              settings.img_directory +
              'heading_beacon_1.svg" class="box" alt="" /></div><div class="heading_markings box"><img src="' +
              settings.img_directory +
              'heading_markings.svg" class="box" alt="" /></div></div><div class="indicator_foreground"><img src="' +
              settings.img_directory +
              'indicator_foreground.svg" class="box" alt="" /></div></div>'
          );
    ...
    this.setTrueAirSpeed = function (speed) {
      _setTrueAirSpeed(speed);
    };
    ...
    this.setOffFlag = function (visible) {
      _setOffFlag(visible);
    };
    this.setILS = function (visible) {
      _setILS(visible);
    };
    this.setILSLocalizer = function (angle) {
      _setILSLocalizer(angle);
    };
    this.setILSGlideslope = function (angle) {
      _setILSGlideslope(angle);
    };
    this.setAltitude = function (altitude) {
      _setAltitude(altitude);
    };
    this.setPressure = function (pressure, milibar) {
      _setPressure(pressure, milibar);
    };
    this.setTurn = function (turn) {
      _setTurn(turn);
    };
    this.setSlip = function (slip) {
      _setSlip(slip);
    };
    this.setHeading = function (heading) {
      _setHeading(heading);
    };
    this.setBeaconOne = function (heading, visible) {
      _setBeaconOne(heading, visible);
    };
    this.setBeaconTwo = function (heading, visible) {
      _setBeaconTwo(heading, visible);
    };
    ...
    this.toggleBox = function (toggle) {
      _toggleBox(toggle);
    };
    this.toggleScrews = function (toggle) {
      _toggleScrews(toggle);
    };
    this.toggleIndicatorInner = function (toggle) {
      _toggleIndicatorInner(toggle);
    };
